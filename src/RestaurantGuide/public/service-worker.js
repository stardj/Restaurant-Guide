...
var dataCacheName = 'rest';
var cacheName = 'restaurantPWA';
var filesToCache = [
    '/',
    '/scripts/app.js',
    ...
    '/javascripts/LoginView.js',
    '/javascripts/RegisterView.js',
    '/javascripts/SearchView.js',
    '/javascripts/DetailView.js',
    '/stylesheets/add.css',
    '/stylesheets/bootstrap.min.css',
    '/stylesheets/rest.css',
...
//     console.log("url === "+e.request.url.indexOf(dataUrl));
