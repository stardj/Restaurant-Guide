var CurrentLocaltion = require('../models/Location');
...
function iSelect(latitude, longitude) {
    ...
    try {
        CurrentLocaltion.find({locate_longitude: latitude, locate_latitude: longitude},
...
exports.save = function (latitude, longitude) {
    ...
    try {
        var location_c = new CurrentLocaltion({
